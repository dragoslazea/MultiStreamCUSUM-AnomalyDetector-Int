...
#
# Generated by export_simulation on Tue Dec 12 09:54:03 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './axis_broadcaster_64x2.sh' script.

./axis_broadcaster_64x2.sh -reset_run
...
./axis_broadcaster_64x2.sh -noclean_files

For more information on the script, please type './axis_broadcaster_64x2.sh -help'.
