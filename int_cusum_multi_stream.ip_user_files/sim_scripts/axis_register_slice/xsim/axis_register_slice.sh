...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_26 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_register_slice xil_defaultlib.axis_register_slice xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_register_slice -key {Behavioral:sim_1:Functional:axis_register_slice} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_register_slice.wdb xsim.dir)
