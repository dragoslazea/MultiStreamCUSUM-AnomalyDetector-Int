...
#
# Generated by export_simulation on Sun Dec 03 16:10:22 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './fifo16x32.sh' script.

./fifo16x32.sh -reset_run
...
./fifo16x32.sh -noclean_files

For more information on the script, please type './fifo16x32.sh -help'.
