...
#
# Generated by export_simulation on Sun Dec 03 17:13:27 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './fifo16x64.sh' script.

./fifo16x64.sh -reset_run
...
./fifo16x64.sh -noclean_files

For more information on the script, please type './fifo16x64.sh -help'.
